                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="Texts">
                            ...
                            <textarea name="Texts" id="Texts" rows="10" class="form-control FormInput" placeholder='Text'><?= $data->Texts ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="Soal">
                            <label class='control-label'>Soal</label>
                            <textarea name="Soal" id="Soal" rows="10" class="form-control FormInput" placeholder='Soal'><?= $data->Soal ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="A">
                            <label class='control-label'>Pilihan A</label>
                            <textarea name="A" id="A" rows="5" class="form-control FormInput" placeholder='Pilihan A'><?= $data->A ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="B">
                            <label class='control-label'>Pilihan B</label>
                            <textarea name="B" id="B" rows="5" class="form-control FormInput" placeholder='Pilihan B'><?= $data->B ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="C">
                            <label class='control-label'>Pilihan C</label>
                            <textarea name="C" id="C" rows="5" class="form-control FormInput" placeholder='Pilihan C'><?= $data->C ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="D">
                            <label class='control-label'>Pilihan D</label>
                            <textarea name="D" id="D" rows="5" class="form-control FormInput" placeholder='Pilihan D'><?= $data->D ?></textarea>
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <select name="KodePaket" id="KodePaket" class="form-control select-paket FormInput">
                                ...
                                <?php foreach($paket_soal as $key => $iData){ 
                                    $sel = $data->KodePaket == $iData['Kode'] ? "selected" : "";
                                ?>
                                    <option value="<?= $iData['Kode'] ?>" <?= $sel; ?>><?= $iData['Nama'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <div class="input-group">
                                ...
                                <select name="KunciJawaban" id="KunciJawaban" class="form-control FormInput">
                                    ...
                                    <option value="A" <?php if($data->KunciJawaban == "A"){ echo "selected"; } ?>>A</option>
                                    <option value="B" <?php if($data->KunciJawaban == "B"){ echo "selected"; } ?>>B</option>
                                    <option value="C" <?php if($data->KunciJawaban == "C"){ echo "selected"; } ?>>C</option>
                                    <option value="D" <?php if($data->KunciJawaban == "D"){ echo "selected"; } ?>>D</option>
                                </select>
                                <span class="input-group-addon">Bobot</span>
                                <input type="text" class="form-control FormInput" name='Bobot' id="Bobot" placegolder="Bobot" value="<?= $data->Bobot ?>">
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success : function(res){
                ...
                if(result['status'] === true){
                    sukses("update", "Soal", "005");
                    scrolltop();
                    setInterval(() => {
                        location.href = "<?= base_url("admins/soal/") ?>";
                    }, 1000);
                    StopLoad();
                }else{
