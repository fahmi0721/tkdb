                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input type='text' autocomplete=off name='NoKtp' id='NoKtp' class='form-control FormInput' placeholder='No KTP' />
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                        ...
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input type='text' autocomplete=off name='TglLahir' id='TglLahir' class='form-control FormInput' placeholder='Tanggal Lahir' />
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input type='text' autocomplete=off name='Jabatan' id='Jabatan' class='form-control FormInput' placeholder='Jabatan' />
                        </div>
                        <div class='col-sm-6 col-md-6'>
...
<script>
    ...
    function SubmitData(){
        ...
        $.ajax({
            type : "POST",
            url : "<?= base_url('admins/peserta/tambah') ?>",
            data : iData,
            beforeSend : function(){
                StartLoad();
            },
