    ...
    <div class="box-header with-border">
        ...
        <div class='pull-right box-tools'>
            <div class='btn-group' id='BtnControl'>
                <a href='<?= base_url('admins/gambar/form-tambah') ?>' class='btn btn-sm btn-primary' title='Tambah data' data-toggle='tooltip'><i class='fa fa-plus'></i> Tambah</a>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getData(){
        table = $('#TableData').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('admins/gambar/get_data_peserta')?>",
                "type": "POST",
                async: true,
    ...
    function HapusData(Id){
        ...
        if(conf){
            $.ajax({
                type : "GET",
                url : "<?= site_url('admins/gambar/hapus') ?>",
                data : "Id="+Id,
                beforeSend: function(){
                    StartLoad();
                },
