...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Tambah Paket Soal</h3>
    </div>
                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input type='text' autocomplete=off name='Kode' id='Kode' class='form-control FormInput' placeholder='Kode Paket' />
                        </div>
                        <div class='col-sm-6 col-md-6'>
                            <label class='control-label'>Nama Paket <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off name='Nama' id='Nama' class='form-control FormInput' placeholder='Nama Paket' />
                        </div>
                    </div>
...
<script>
    ...
    function SubmitData(){
        ...
        $.ajax({
            type : "POST",
            url : "<?= base_url('admins/paket/tambah') ?>",
            data : iData,
            beforeSend : function(){
                StartLoad();
            },
