...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Tambah User Login</h3>
    </div>
            ...
            <div class='col-md-8 col-sm-9'>
                ...
                <div class='form-group'>
                        <div class='col-sm-12 col-md-12'>
                            ...
                            <input type='text' autocomplete=off name='Nama' id='Nama' class='form-control FormInput' placeholder='Nama Lengkap' />
                        </div>
                    ...
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input type='text' autocomplete=off name='Username' id='Username' class='form-control FormInput' placeholder='Username' />
                        </div>
                        <div class='col-sm-6 col-md-6'>
...
<script>
    function ValidasiForm(){
        var iForm = ["Nama","Username","Password"];
        var iKet = ["Nama belum lengkap!. mohon dilengkapi","Username  belum lengkap!. mohon dilengkapi","Password  belum lengkap!. mohon dilengkapi"];
        var no = 1;
    ...
    function SubmitData(){
        ...
        $.ajax({
            type : "POST",
            url : "<?= base_url('admins/login/tambah') ?>",
            data : iData,
            beforeSend : function(){
                StartLoad();
            },
